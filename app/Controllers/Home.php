...
class Home extends BaseController
{
    ...
    public function bokingd(){
         // Ambil data dari input
         $checkin = $this->request->getPost('checkind');
         $checkout = $this->request->getPost('checkoutd');
        ...
        $message .= "Check-in Date: $checkin\n";
        $message .= "Check-out Date: $checkout\n";
        $message .= "Room Type: Double Room With Terrace\n";
        $message .= "Name : $name\n";
        $message .= "Note: $note\n\n";
        $message .= "Please let me know if any additional information is needed to complete the reservation process. I look forward to a pleasant stay at Get's House. Thank you for your assistance.\n\n";
    ...
    public function simpan(){
         // Ambil data dari input
         $star = $this->request->getPost('rate');
         $name = $this->request->getPost('name-re');
         $opjektif = $this->request->getPost('input-riview');
